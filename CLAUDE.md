...
| `pipo-cuida-003`   | web  | Blocked by `pipo-cuida-002` | Build the Olimpipo edition ranking screen | [design](.claude/specs/pipo-cuida-003-olimpipo-ranking-design.md)          | [plan](.claude/plans/pipo-cuida-003-olimpipo-ranking-plan.md)              |
